...
/// <param name="isExtension">true : 読み込んだファイル名の拡張子を含む</param>
/// <param name="isExtension">false : 読み込んだファイル名の拡張子を消す</param>
/// <returns></returns>
...
bool InScreen(Vector2 pos, Vector2 scrollValue = { 0,0 }, Vector2 offsetValue = { 0,0 });